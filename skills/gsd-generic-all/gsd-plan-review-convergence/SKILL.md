...
description: [通用版] "Cross-AI plan convergence loop — replan with review feedback until no HIGH concerns remain (max 3 cycles)"
...
<execution_context>
@.planning/workflows/plan-review-convergence.md
@.planning/references/revision-loop.md
@.planning/references/gates.md
@.planning/references/agent-contracts.md
</execution_context>
...
<process>
Execute the plan-review-convergence workflow from @.planning/workflows/plan-review-convergence.md end-to-end.
